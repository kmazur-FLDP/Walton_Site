...
const CitrusMapPage = () => {
  ...
  useEffect(() => {
    ...
    if (parcelsParam && parcelData) {
      ...
      console.log('Loading multiple parcels for Citrus:', parcelIds)
      ...
      if (matchedParcels.length > 0) {
        ...
        console.log(`Found ${matchedParcels.length} of ${parcelIds.length} requested parcels for Citrus`)
        ...
        console.warn('No matching parcels found for Citrus')
      }
